            ...
            <div className="flex items-center justify-center font-sans">
                ...
                <div className="bg-white shadow-md rounded my-6">
                    ...
                    <tbody className="text-gray-600 text-sm font-light">
                        {data.map((v) => {
                            return(
                                <tr key={v.ts} id={v.ts} className="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td className="url py-3 px-6 text-center">
                                        <div className="cursor-pointer hover:bg-gray-50 text-gray-600 px-1 rounded-full text-xs">
                                    ...
                                    <td className="update py-3 px-6 text-center">
                                        <div className="text-center">
                                            <span onClick={update} className="cursor-pointer bg-gray-200 text-gray-600 py-1 px-3 rounded-full text-xs">Update</span>
                                        </div>
                                    </td>
                                    <td className="delete py-3 px-6 text-center">
                                        <div className="text-center">
                                            <span onClick={del} className="cursor-pointer bg-gray-200 text-gray-600 py-1 px-3 rounded-full text-xs">Delete</span>
                                        </div>
                                    </td>
                                </tr>
                            )
...
{/* <td className="upcoming-freeze py-3 px-6 text-center">
